...
namespace CCvLibrary
{
    public class CCvFunc : CCv
    {
        ...
        public BitmapSource DoCvFunction(List<String> srcNames, int mode)
        {
            ...
            {
                case 0:
                    Cv2.Add(MatSrc1, MatSrc2, mDst);
                    break;
                case 1:
                    Cv2.Subtract(MatSrc1, MatSrc2, mDst);
                    break;
                case 2:
                    Cv2.BitwiseAnd(MatSrc1, MatSrc2, mDst);
                    break;
                case 3:
                    Cv2.BitwiseOr(MatSrc1, MatSrc2, mDst);
                    break;
                case 4:
                    Cv2.BitwiseXor(MatSrc1, MatSrc2, mDst);
                    break;
            }
